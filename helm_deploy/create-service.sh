...
[ $# -ne 6 ] && { echo "Usage: $0 namespace env_name court_case_service_path values_file domain cert_secret"; exit 1; }
...
domain=$5                                                          # host domain
cert_secret=$6                                                     # TLS cert secret name
...
--set ingress.hosts[0].host=$deployment_name.$domain \
